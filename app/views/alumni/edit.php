<main>
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="bg-white w-full dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <!-- Responsive Table -->
            <form action="<?= base_url; ?>/admin/alumni/updateAlumni" method="post" class="w-full mx-auto" enctype="multipart/form-data">

                <!-- ID (Hidden) -->
                <input type="hidden" name="uuid" value="<?= $data['alumni']['uuid']; ?>">
                ...
                <div class="mb-5">
                    ...
                    <input maxlength="100" type="text" id="tempat_lahir" name="tempat_lahir"
