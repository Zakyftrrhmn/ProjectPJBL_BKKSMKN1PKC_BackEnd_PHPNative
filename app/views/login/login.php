            ...
            <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
                <div>
                    <a href="javascript:void(0)"><img
                            src="<?= base_url ?>/assets/src/images/logo/logo.svg" alt="logo" class='w-52 mb-12 inline-block' />
                    </a>
                ...
                <form action="<?= base_url; ?>/login/prosesLogin" method="post" class="bg-white rounded-xl px-6 py-8 space-y-6 max-w-md md:ml-auto w-full">
                    ...
                    <p class="my-6 text-sm text-gray-400 text-center">Lihat Tampilan Halaman depan</p>
