        ...
        <div
            ...
            <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
                ...
                <a class="block flex-shrink-0 lg:hidden" href="index.html">
                    <img src="<?= base_url ?>/assets/src/images/logo/logo-ico.svg" alt="Logo" />
                </a>
            </div>
                ...
                <div
                    ...
                    <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                        <span class="hidden text-right lg:block">
                            <span class="block text-sm font-medium text-black dark:text-white"><?= $_SESSION['nama'] ?></span>
                            <span class="block text-xs font-medium"><?= $_SESSION['role'] ?></span>
                        </span>

                        <span>
                            <!-- Menampilkan gambar profil -->
                            <img class="w-10 h-10 rounded-full object-cover"
                                src="<?= base_url ?>/uploads/user/<?= !empty($_SESSION['photo']) && file_exists('uploads/user/' . $_SESSION['photo']) ? $_SESSION['photo'] : 'default-user.jpeg' ?>"
                                alt="User" />
