<main>
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="bg-white w-full dark:bg-gray-800 shadow rounded-lg p-6">
            ...
            <!-- Responsive Table -->
            <form action="<?= base_url; ?>/admin/perusahaan/updatePerusahaan" method="post" class="w-full mx-auto" enctype="multipart/form-data" id="form">
                <input type="hidden" name="uuid" value="<?= $data['perusahaan']['uuid']; ?>" />
                ...
                <div class="mb-5">
                    ...
                    <input maxlength="100" type="text" id="alamat_perusahaan" name="alamat_perusahaan" rows="3"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                        value="<?= $data['perusahaan']['alamat_perusahaan']; ?>" placeholder="Alamat lengkap perusahaan" required>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input maxlength="100" type="text" id="industry_perusahaan" name="industry_perusahaan"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
