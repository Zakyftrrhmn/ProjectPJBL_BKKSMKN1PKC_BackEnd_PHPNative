        ...
        <div class="bg-white w-full dark:bg-gray-800 shadow rounded-lg p-6">
            <?php foreach ($data['info'] as $row) : ?>
                ...
                <form action="<?= base_url; ?>/info/updateInfo" method="post" class="w-full mx-auto" enctype="multipart/form-data" id="form">
                    ...
                    <input type="hidden" name="id" value="<?= $data['info'][0]['id']; ?>" />
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="link_facebook" name="link_facebook"
                            ...
                            value="<?= $data['info'][0]['link_facebook']; ?>" required />
                    </div>

                    <div class="mb-5">
                        <label for="link_instagram" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Facebook</label>
                        <input type="text" id="link_instagram" name="link_instagram"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            value="<?= $data['info'][0]['link_instagram']; ?>" required />
                    </div>

                    <div class="mb-5">
                        <label for="link_youtube" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Facebook</label>
                        <input type="text" id="link_youtube" name="link_youtube"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            value="<?= $data['info'][0]['link_youtube']; ?>" required />
                    </div>

                    <div class="mb-5">
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Facebook</label>
                        <input type="text" id="email" name="email"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            value="<?= $data['info'][0]['email']; ?>" required />
                    </div>

                    <div class="mb-5">
                        <label for="telepon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link Facebook</label>
                        <input type="text" id="telepon" name="telepon"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            value="<?= $data['info'][0]['telepon']; ?>" required />
                    </div>
